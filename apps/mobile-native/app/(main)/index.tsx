...
import { clearWebViewCookies } from "@/src/lib/webview-cookies";
  ...
  return (
    ...
    >
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          const isLaunchable = item.status === "active";

          return (
            <Pressable
              disabled={!isLaunchable}
              accessibilityState={{ disabled: !isLaunchable }}
              onPress={() =>
                router.push({
                  pathname: "/apps/[appId]",
              ...
              style={({ pressed }) => [
                ...
                !isLaunchable && styles.appCardDisabled,
                pressed && isLaunchable && styles.rowPressed,
              ]}
            >
