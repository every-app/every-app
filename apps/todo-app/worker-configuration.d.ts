/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0d6bf9fd9a3cf9dd03728d24ee3e8241)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GATEWAY_URL: string;
		USER_SYNC: DurableObjectNamespace<import("./src/entry.worker").UserSyncDO>;
		DB: D1Database;
