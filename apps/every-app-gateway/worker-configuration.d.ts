/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 5399051ba42d1a68432567623dea4766)
...
declare namespace Cloudflare {
	interface Env {
		...
		DB: D1Database;
		RATE_LIMIT_AUTH_TOKEN: RateLimit;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEWAY_URL" | "BETTER_AUTH_SECRET" | "JWT_PRIVATE_KEY" | "JWT_PUBLIC_KEY">> {}
}
