/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 86a3162ef2480424a78c8c03243d732c)
// Runtime types generated with workerd@1.20251011.0 2025-08-13 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		"every-app-gateway": KVNamespace;
		GATEWAY_URL: "Set to localhost:3000 or it's automatically set during `every app deploy`";
		CORE_APP_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEWAY_URL" | "CORE_APP_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "JWT_PRIVATE_KEY" | "JWT_PUBLIC_KEY">> {}
}
