...
```bash
npx @every-app/cli gateway deploy # Deploys the Gateway
npx @every-app/cli app create    # Sets up local dev enviornment + deploys app (needed for local dev)
npx @every-app/cli app deploy    # Deploy updates to your app
```
