/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a930906973fa9f41ac0930d06fc264e5)
// Runtime types generated with workerd@1.20251011.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		GATEWAY_URL: "THIS IS SET DURING `every app deploy`";
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEWAY_URL">> {}
}
